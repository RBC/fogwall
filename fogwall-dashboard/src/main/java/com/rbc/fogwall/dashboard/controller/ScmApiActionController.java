...
public class ScmApiActionController {
    ...
    @Operation(
            ...
            description =
                    "Returns SCM API proxy mutation records ordered by most recent first. Filter by status (FORWARDED, DENIED, ERROR), provider, resolved user, repo owner/name, or free-text search. Paginate with limit/offset.")
    @GetMapping
