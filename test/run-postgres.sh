#!/usr/bin/env bash
# Spin up fogwall + Gitea + PostgreSQL, run the full test/... suite, then tear down.
#
# Usage:
...
COMPOSE="docker compose --profile postgres -f ${REPO_ROOT}/docker/docker-compose.yml -f ${REPO_ROOT}/docker/docker-compose.postgres.yml"
