 ...
 *
 * <p>Deliberately a hardcoded table, not config-driven, for the same reason as {@link GitHubMutationAllowlist} — this
 * is the security boundary, not an operator knob.
 */
