 ...
 */
public class JdbcNodeIdCache implements NodeIdCache {

    private static final Logger log = LoggerFactory.getLogger(JdbcNodeIdCache.class);

    private final NamedParameterJdbcTemplate jdbc;
    private final TransactionTemplate tx;
    private final Duration maxAge;

    public JdbcNodeIdCache(DataSource dataSource, Duration maxAge) {
