...
public final class GitLabTargetProject {
    ...
    /**
     * Extracts the target project from a {@code glab} merge-request body. Only accepts an integral ID, which is the
     * form GitLab documents and {@code glab} sends; a string, float, or object is reported as {@link Result.Unusable}
     * rather than coerced, since guessing at a malformed authorization subject is the failure this exists to prevent.
     */
