...
public class GitRequestDetails {
     ...
     * {@link UserEntry} has a matching SCM identity for the provider. Use this for provider profile links —
     * {@link #resolvedUser} is the proxy account, not the SCM handle.
     */
    private String scmUsername;

    private List<FogwallFilter> filters = new ArrayList<>();
