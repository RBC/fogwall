 ...
 * {@link com.rbc.fogwall.scmapi.JdbcNodeIdCache}.
 */
public class MongoNodeIdCache implements NodeIdCache {

    private static final Logger log = LoggerFactory.getLogger(MongoNodeIdCache.class);
    private static final String COLLECTION_NAME = "scm_api_github_node_cache";

    private final MongoDatabase database;
    private final Duration maxAge;

    public MongoNodeIdCache(MongoClient mongoClient, String databaseName, Duration maxAge) {
