...
import static com.rbc.fogwall.git.GitClientUtils.AnsiColor.CYAN;
import static com.rbc.fogwall.git.GitClientUtils.SymbolCodes.LINK;
import static com.rbc.fogwall.git.GitClientUtils.buildValidationSummary;
 ...
 * {@link FogwallFilter} - it must always run to set the final result status regardless of approval state.
 *
