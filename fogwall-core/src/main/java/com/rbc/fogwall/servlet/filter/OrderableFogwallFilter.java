...
/**
 * Extension of {@link FogwallFilter} for user-configurable filters whose execution order can be changed at runtime.
 *
 ...
 *
 * <p>Valid values follow the ranges documented in {@link FogwallFilter}. The authorization range (0-199) is suitable
 ...
 */
public interface OrderableFogwallFilter extends FogwallFilter {
     ...
     *
     * @param order the desired execution order; see {@link FogwallFilter} for reserved ranges
     */
